...
const CRITICAL_PATTERNS = [
  /segura[nç]/i, /autentica/i, /auth/i, /token/i, /secret/i, /refatora[çc][aã]o grande/i,
  /action-executor/i, /workspace-store/i, /server\.ts/i, /m[uú]ltiplos arquivos/i,
  /arquivos centrais/i, /permiss[aã]o/i, /vulnerab/i, /xss/i, /csrf/i, /criptograf/i
];

const MEDIUM_PATTERNS = [
  /cri[ae] (tela|landing|dashboard|p[aá]gina)/i, /cri[ae] (componente)/i,
  /altera[rn]/i, /modifica[rn]/i, /corrig[ei]r? erro de build/i,
  /corrig[ei]r? (erro|falha)/i, /backend/i, /endpoint/i, /api/i,
  /banco de dados/i, /refator/i, /reorganiz/i
];

const SIMPLE_PATTERNS = [
  /cri[ae] arquivo/i, /gera[r]? readme/i, /explica[r]?/i, /o que [eé]/i,
  /ajusta[r]? texto/i, /documenta/i, /coment[ae]/i, /lista[r]?/i,
  /mostra[r]?/i, /qual [eé]/i
];
